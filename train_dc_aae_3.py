...
for epoch in tqdm(range(epochs)):
    ...
    while(1):
        try:
            ...
            imgs, under_imgs, latent_real = next(input_generator)
            ...
            # Train the generator
            g_loss = aae.adversarial_autoencoder.train_on_batch(under_imgs, [imgs, valid])
            ...
            for i in range(batch_size):
                ...
                plt.savefig(f'aae_mse_6/Images/{epoch}_{i}_aae_ssim.png')
            aae.encoder.save(f'aae_mse_6/Models/encoder_aae_ssim_{epoch}.h5')
            aae.decoder.save(f'aae_mse_6/Models/decoder_aae_ssim_{epoch}.h5')    
